package com.fpd.basecore.swipelayout;
...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int dragEdgeChoices = a.getInt(R.styleable.SwipeLayout_drag_edge,
                DRAG_RIGHT);
        mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a
                .getDimension(R.styleable.SwipeLayout_leftEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a
                .getDimension(R.styleable.SwipeLayout_rightEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a
                .getDimension(R.styleable.SwipeLayout_topEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a
                .getDimension(R.styleable.SwipeLayout_bottomEdgeSwipeOffset, 0);
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            if (child == getSurfaceView()) {
                ...
                int surfaceViewTop = surfaceView == null ? 0
                        : surfaceView.getTop();
                switch (mCurrentDragEdge) {
                    case Left:
                    case Right:
    ...
    private void checkCanDrag(MotionEvent ev) {
        ...
        if (mCurrentDragEdge == DragEdge.Left) {
            boolean suitable = (status == Status.Open
    ...
    /**
     * There are 2 diffirent show mode. PullOut and LayDown.
     *
     * @param mode
     */
    ...
    public void open(boolean smooth, boolean notify) {
        ...
        if (smooth) {
            ...
            if (getShowMode() == ShowMode.PullOut) {
                Rect bRect = computeBottomLayoutAreaViaSurface(ShowMode.PullOut,
                        rect);
                if (bottom != null) {
    ...
    private Rect computeBottomLayoutAreaViaSurface(ShowMode mode,
        ...
        if (mode == ShowMode.PullOut) {
            ...
            if (mCurrentDragEdge == DragEdge.Left
                    || mCurrentDragEdge == DragEdge.Right) {
                bb = rect.bottom;
                br = bl + (bottomView == null ? 0
                        : bottomView.getMeasuredWidth());
            } else {
                bb = bt + (bottomView == null ? 0
    ...
    public void setDragEdges(List<DragEdge> dragEdges) {
        for (int i = 0, size = Math.min(dragEdges.size(),
                getChildCount() - 1); i < size; i++) {
    ...
    /**
     * Deprecated, use {@link #addDrag(DragEdge, View)} When using multiple drag edges it's a good idea to pass the ids
     * of the views that you're using for the left, right, top bottom views (-1 if you're not using a particular view)
     */
    @Deprecated
